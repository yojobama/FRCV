...
public class CameraCalibrationResult : global::System.IDisposable {
  ...
  public double rms {
    set {
      libFRCVLibPINVOKE.CameraCalibrationResult_rms_set(swigCPtr, value);
    } 
    get {
      double ret = libFRCVLibPINVOKE.CameraCalibrationResult_rms_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public CameraCalibrationResult(double fx, double fy, double cx, double cy, double rms) : this(libFRCVLibPINVOKE.new_CameraCalibrationResult__SWIG_1(fx, fy, cx, cy, rms), true) {
  }
